        ...
        <div className="mb-12 md:mb-16 mt-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4 md:mt-5 type-lead text-neutral-600 dark:text-neutral-400 reading-lead">
          ...
          return (
            <div key={service.id} className="w-full">
              <div className="mb-4 md:mb-6">
                <h3 className="type-display-lg text-neutral-900 dark:text-white">{displayTitle}</h3>
                <p className="type-body-sm font-normal text-neutral-500 dark:text-neutral-400 mt-1 line-clamp-1">{displaySubtitle}</p>
              </div>
                  ...
                  const cardContent = (
                    <div className="w-full aspect-[4/5] rounded-md overflow-hidden bg-neutral-100 dark:bg-[#1c1c1c] border border-transparent dark:border-neutral-800 relative">
                       ...
                       <div className="absolute inset-x-0 bottom-0 py-2 px-2 bg-gradient-to-t from-black/60 to-transparent">
                          <p className="type-label-md font-semibold text-white leading-tight">
                            {displayLabel}
                          </p>
                       </div>
                    </div>
