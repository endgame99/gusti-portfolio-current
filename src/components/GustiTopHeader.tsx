...
export function GustiTopHeader({
  ...
  return (
    <header
      className={cx(
        "fixed top-0 right-0 z-[90] flex h-12 items-center justify-between bg-white/95 px-4 backdrop-blur-md transition-all duration-300 dark:bg-[#121212]/95",
        collapsed ? "left-0 md:left-[56px]" : "left-0 md:left-[164px]"
      )}
    >
      <div className="flex min-w-0 flex-1 items-center gap-2">
        <div className="relative flex h-8 w-28 xs:w-40 sm:w-60 md:w-72 lg:w-80 items-center rounded-full bg-neutral-100 dark:bg-neutral-900 transition-all duration-300">
      ...
      <div className="flex items-center gap-1.5">
        <a
          href="#"
          className="hidden h-8 items-center gap-1.5 rounded-full border border-neutral-200 px-3 text-[11px] font-bold text-neutral-600 transition hover:bg-neutral-100 hover:text-neutral-950 dark:border-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-white sm:flex"
        >
          <Download size={13} />
          Download CV
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex h-8 items-center rounded-full bg-neutral-950 px-4 text-[11px] font-black text-white transition hover:scale-[1.03] active:scale-95 dark:bg-white dark:text-neutral-950"
        >
          Hire Me
        </a>
        ...
        <button
          ...
          className="hidden h-8 items-center gap-1 rounded-full px-2 text-[11px] font-bold text-neutral-600 transition hover:bg-neutral-100 hover:text-neutral-950 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-white sm:flex"
